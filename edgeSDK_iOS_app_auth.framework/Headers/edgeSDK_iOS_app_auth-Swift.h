...
SWIFT_CLASS("_TtC20edgeSDK_iOS_app_auth15AuthStateResult")
@interface AuthStateResult : NSObject
@property (nonatomic, strong) AuthStatus * _Nullable status;
...
SWIFT_CLASS("_TtC20edgeSDK_iOS_app_auth20GenericContentResult")
...
///
- (void)authorizeWithAuthConfig:(AuthConfig * _Nonnull)authConfig viewController:(UIViewController * _Nonnull)viewController completion:(void (^ _Nonnull)(AuthStateResult * _Nonnull))completion;
...
/// \param completion Completion block returning an AuthStateResult object.
///
- (void)unauthorizeWithAuthConfig:(AuthConfig * _Nonnull)authConfig viewController:(UIViewController * _Nonnull)viewController completion:(void (^ _Nonnull)(AuthStateResult * _Nonnull))completion;
...
///
- (void)edgeIdTokenDecoded:(void (^ _Nonnull)(GenericContentResult * _Nonnull))completion;
